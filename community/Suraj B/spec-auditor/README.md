...
spec-auditor/
  ...
  README.md             this file
  scripts/              the structural analyser
  references/           background docs loaded only when needed
  tests/                trigger cases, sample specs, results
```

If you want to fork this for a different kind of audit, like threat models, migration plans, or test plans, read ADOPTING.md.
